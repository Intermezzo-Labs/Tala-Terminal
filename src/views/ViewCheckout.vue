...
import CheckoutMethodCash from '@/components/checkout/CheckoutMethodCash.vue'
import CheckoutMethodCreditCard from '@/components/checkout/CheckoutMethodCreditCard.vue'
import CheckoutMethodEWallet from '@/components/checkout/CheckoutMethodEWallet.vue'
import CheckoutMethods from '@/components/checkout/CheckoutMethods.vue'
import LoadingScreen from '@/components/LoadingScreen.vue'
import AppIcon from '@/components/AppIcon.vue'
import { formatCurrency, checkoutMethods } from '@/utils'
